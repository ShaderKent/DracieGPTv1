...
# from server.gpt_download3 import download_and_load_gpt2
...
checkpoint_load = "GPT-2_124M_Instructions.pth"
# checkpoint_load = "GPT-2_355M_Instructions.pth"
checkpoint_save = "GPT-2_124M_Instructions.pth"
...
#CURRENTLY DISABLED, VESTIGIAL => VALUES HAVE BEEN DOWNLOADED
...
def generate_alpaca_dataloaders():
    ...
    # data = alpaca_full.alpaca_data[7001:8000] # Current completed 355M
...
#RUN QUERY ON ALPACA FINETUNED MODEL (TERMINAL)
# loop_active = True
